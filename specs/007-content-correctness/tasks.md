...
- [x] T046 Compare production output only after expected v2 decisions are saved; verify every raw heading disposition, body match, hierarchy, role, TOC and split without auto-updating ground truth
- [x] T047 Verify protected ranges and expected diagnostics for all fifteen books
- [x] T048 Run exact fifteen-book comparator and resolve every implementation mismatch without rewriting correct ground truth

...
The stress generator creates a Cloud-shaped `full.md`, `content_list.json`, `layout.json`
and deterministic SVG resources. Defaults are 500 pages, 20 paragraphs per page and 32
